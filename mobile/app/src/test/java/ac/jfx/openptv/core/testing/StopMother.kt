 ...
 *
 * Promoted to `:core:testing` alongside the multi-module split. See `~/.claude/skills/object-mother/skill.md`
 * for the pattern spec and project CLAUDE.md for the project-wide requirement.
 */
